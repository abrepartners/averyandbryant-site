        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-[13px] font-light uppercase tracking-[0.2em] text-fg">
                Avery &amp; Bryant
              </span>
            </div>
            ...
            <div className="mt-6 flex gap-4">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded border border-border text-fg-secondary transition-colors hover:border-crimson/30 hover:text-white"
                >
          ...
          {/* Services */}
          <div>
            <h3 className="text-[10px] font-medium uppercase tracking-[0.25em] text-fg-secondary">
              Services
            </h3>
          ...
          <div>
            ...
            <h3 className="mt-8 text-[10px] font-medium uppercase tracking-[0.25em] text-fg-secondary">
              Account
            </h3>
            <ul className="mt-4 space-y-2.5">
              {account.map((a) =>
            ...
            <div className="mt-4 space-y-6">
              {locations.map((loc) => (
                <div key={loc.city}>
                  ...
                  <div className="mt-1.5 flex items-start gap-2 text-fg-secondary">
                    <MapPin className="mt-0.5 h-3.5 w-3.5 shrink-0" />
                    <span className="text-xs leading-relaxed">
                      {loc.address}
                    </span>
                  </div>
                  <div className="mt-1 flex items-center gap-2 text-fg-secondary">
